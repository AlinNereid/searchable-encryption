...
public class SSKEEcorePackageImpl extends EPackageImpl implements SSKEEcorePackage {
     ...
     *
     * <p>
     * This method is used to initialize {@link SSKEEcorePackage#eINSTANCE} when that field is accessed. Clients should
    ...
    public static SSKEEcorePackage init() {
        if (isInited) {
            return (SSKEEcorePackage) EPackage.Registry.INSTANCE.getEPackage(eNS_URI);
        }
        ...
        EPackage.Registry.INSTANCE.put(eNS_URI, theSSKEEcorePackage);
    ...
    public void initializePackageContents() {
        ...
        initEClass(aesEClass, AES.class, "AES", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getAES_IV(), theXMLTypePackage.getString(), "IV", null, 0, 1, AES.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getAES_Mode(), this.getBlockCipherModeOfOperation(), "Mode", null, 0, 1, AES.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEClass(sskeEClass, SSKE.class, "SSKE", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getSSKE_Sskekeys(), this.getSSKEKeys(), null, "sskekeys", null, 1, 1, SSKE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getSSKE_Sskedecryptor(), this.getSSKEDecryptor(), null, "sskedecryptor", null, 1, 1, SSKE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getSSKE_Sskeencryptor(), this.getSSKEEncryptor(), null, "sskeencryptor", null, 1, 1, SSKE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
