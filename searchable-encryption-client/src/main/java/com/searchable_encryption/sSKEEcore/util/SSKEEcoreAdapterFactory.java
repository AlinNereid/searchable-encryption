...
/**
 * <!-- begin-user-doc -->
 * The <b>Adapter Factory</b> for the model. It provides an adapter <code>createXXX</code> method for each class of the
 * model.
 * <!-- end-user-doc -->
 *
...
public class SSKEEcoreAdapterFactory extends AdapterFactoryImpl {
    ...
    /**
     * Creates a new adapter for an object of class '{@link alin.sske.sSKEEcore.PseudoRandomGenerator <em>Pseudo Random
     * Generator</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases; it's useful to ignore a case when
     * inheritance will catch all the cases anyway.
    ...
    /**
     * Creates a new adapter for an object of class '{@link alin.sske.sSKEEcore.PseudoRandomFunction <em>Pseudo Random
     * Function</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases; it's useful to ignore a case when
     * inheritance will catch all the cases anyway.
    ...
    /**
     * Creates a new adapter for an object of class '{@link alin.sske.sSKEEcore.SymmetricEncryptor <em>Symmetric
     * Encryptor</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases; it's useful to ignore a case when
     * inheritance will catch all the cases anyway.
    ...
    /**
     * Creates a new adapter for an object of class '{@link alin.sske.sSKEEcore.SymmetricDecryptor <em>Symmetric
     * Decryptor</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases; it's useful to ignore a case when
     * inheritance will catch all the cases anyway.
    ...
    /**
     * Creates a new adapter for an object of class '{@link alin.sske.sSKEEcore.SSKEKeysGenerator <em>SSKE Keys
     * Generator</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases; it's useful to ignore a case when
     * inheritance will catch all the cases anyway.
