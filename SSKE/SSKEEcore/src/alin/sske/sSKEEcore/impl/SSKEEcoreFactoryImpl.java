...
public class SSKEEcoreFactoryImpl extends EFactoryImpl implements SSKEEcoreFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case SSKEEcorePackage.SSKE_ENCRYPTOR: return createSSKEEncryptor();
			case SSKEEcorePackage.SSKE_DECRYPTOR: return createSSKEDecryptor();
			case SSKEEcorePackage.AES: return createAES();
			case SSKEEcorePackage.SSKE_KEYS: return createSSKEKeys();
			case SSKEEcorePackage.SSK_KEYS_TXT: return createSSKKeysTxt();
			case SSKEEcorePackage.SSKE: return createSSKE();
			case SSKEEcorePackage.SSKE_KEYS_GENERATOR: return createSSKEKeysGenerator();
			case SSKEEcorePackage.SSK_KEYS_JSON: return createSSKKeysJson();
			default:
